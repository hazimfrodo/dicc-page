...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/UniversityOfMalaya",
    icon: (
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/unimalaya",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/unimalaya",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "http://www.youtube.com/user/UniOfMalaya",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
